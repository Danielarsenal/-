 ...
 * @Last Modified time: 2016-12-17 16:24:34
 */
...
//     }
// })
myApp.controller('gsproductController', ['$scope', '$http', '$routeParams',
    function($scope, $http, $routeParams) {
        ...
        // }
        $scope.boxShow = -1;
        $scope.shopShow = function(index) {
            //0 index   == -1  $scope.boxShow     $scope.boxShow = 0
            //0 index == 0  $scope.boxShow   $scope.boxShow = -1
            // 1 index == -1 $scope.boxShow  $scope.boxShow = 1
            // 1 index == 1 $scope.boxShow $scope.boxShow = -1
